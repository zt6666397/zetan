...
export var Upload = function (props) {
    ...
    return (React.createElement("div", { className: "zetan-upload-component" },
        React.createElement("div", { className: "zetan-upload-input", style: { display: 'inline-block' }, onClick: handleClick },
            drag ?
                React.createElement(Dragger, { onFile: function (files) { uploadFiles(files); } }, children) :
                children,
            React.createElement("input", { className: "zetan-file-input", style: { display: 'none' }, ref: fileInput, onChange: handleFileChange, type: "file", accept: accept, multiple: multiple })),
