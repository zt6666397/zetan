...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "zetan-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "zetan-upload-list-item", key: item.uid },
